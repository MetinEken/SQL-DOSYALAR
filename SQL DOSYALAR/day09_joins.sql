...
------------------------------------------------------------------------------*/   
    ...
    --NOT left dedigimiz zaman ilk tablodaki tum vereileri alicak ama sag tablodaki listeden sadece sol ile uyum saglayanlar alinir.
    -- right dedigimiz zaman ise sagdaki tum veriuler alinacak soldaki tablodan sag ile uyum saglayanlar alir.
    -- hepsi alinan tablodan karsiligi olmayan verriler olursa null ile gosterilir.
